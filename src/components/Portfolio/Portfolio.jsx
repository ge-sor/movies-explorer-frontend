...
const Portfolio = () => {
    return <section className={'portfolio section'}>
        <div className={'portfolio__content content'}>
            ...
            <a href={'https://github.com/ge-sor/how-to-learn'} className={'portfolio-link link'} target="_blank"
               rel="noreferrer">
                Статичный сайт <span className={'portfolio-link__span'}>↗</span>
            </a>
            <a href={'https://github.com/ge-sor/russian-travel'} className={'portfolio-link link'} target="_blank"
               rel="noreferrer">
                Адаптивный сайт <span className={'portfolio-link__span'}>↗</span>
            </a>
            <a href={'https://github.com/ge-sor/react-mesto-api-full'} className={'portfolio-link link'} target="_blank"
               rel="noreferrer">
